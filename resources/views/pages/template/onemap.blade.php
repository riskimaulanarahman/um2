...
@section('content')
	...
	<div class="map-content">
		<div class="btn-group map-btn pull-right d-none d-xl-block" style="position:absolute;left:43px;width:159px;" >
					...
					<a href="#modal-bangunan" class="btn btn-lg btn-purple" data-toggle="modal">
						...
						<a href="#modal-penghuni" class="btn btn-lg btn-warning" data-toggle="modal">
							<span class="d-flex align-items-center text-left">
								...
								<span>
									<span class="d-block mb-n1"><b>Data Penghuni & Rumah Tangga</b></span>
									<span class="f-s-12 f-w-600 text-white-transparent-7 menu-idbangunan">-information-</span>
								</span>
							</span>
						</a>
							...
							<div id="accordion" class="accordion">
								...
								<div class="card">
									<div class="card-header pointer-cursor d-flex align-items-center collapsed" data-toggle="collapse" data-target="#collapseTwo">
										<i class="fa fa-balance-scale fa-fw text-indigo mr-2 f-s-8"></i> DATA RUMAH TANGGA
									</div>
										...
										<div class="card-body">
												<div class="table-responsive table-sales" style="margin-top:0px;">
													<table class="table">
                                                            ...
                                                            <td>Rumah Tangga Induk
                                                                <ul>
                                                                    <li><span id="ekonomi_item01"></span></li>
                                                                </ul>
                                                            </td>
                                                            <td class="text-right">
    ...
    <div class="modal fade" id="tematikModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-tematik modal-lg" style=" margin-top: 0px; ">
          <div class="modal-content">
            <!-- <div class="modal-header">
            ...
            <div class="modal-body">
              <div id="content_modal">
                <!-- <span id="judul" style="text-transform: capitalize;"></span>
                <hr width="100%" align="center"> -->
                <span ><strong>Data Ringkasan</strong></span>
                <div id="loadingtematik" center>
                  <img src="public/img/ajax-loader.gif" alt="" width="50px" height="50px"> Loading...
                </div>
                <div id="isi_tematik">
                </div>
              </div>
            ...
            <div class="modal-footer text-center">
              <button type="button" class="btn btn-info btn-round" data-dismiss="modal"><i class="material-icons">clear</i></button>
            </div>
          </div>
        </div>
      </div>
    ...
    <button id="btn_modal_tematik" class="btn_modal_tematik" data-toggle="modal" data-target="#tematikModal"></button>
@endsection
...
@push('scripts')
	...
	<script src="/assets/js/map-spasial.js?n=332422"></script>
