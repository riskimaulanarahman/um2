...
<body class="{{ $bodyClass }}">
	...
	<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed {{ $pageContainerClass }}">
		...
		{{-- @include('includes.component.tematik-panel') --}}

		@include('includes.component.analys-panel')
		{{-- @include('includes.component.rumahtangga-panel')
		@include('includes.component.anggota-panel') --}}
