...
-- Dumping data for table rtlapor.log_sendmail: ~21 rows (approximately)
...
-- Dumping data for table rtlapor.tbl_laporan: ~4 rows (approximately)
...
INSERT INTO `tbl_laporan` (`id`, `id_users`, `gambar`, `judul`, `laporan`, `status`, `aksi`, `created_at`, `updated_at`) VALUES
	(18, 50, 'warga lapor_1621764742_test.png', 'lapor 1', 'okeoke', 'dibaca', 'proses', '2021-05-23 18:12:22', '2021-05-26 23:24:57'),
	(19, 50, 'warga lapor_1621773201_Screen Shot 2021-05-23 at 19.44.18.png', 'lapor 2', 'mantap', 'dibaca', 'menunggu', '2021-05-23 20:33:21', '2021-05-25 20:56:12'),
	(20, 50, 'warga lapor_1622044049_Screen Shot 2021-05-24 at 23.06.50.png', 'lapor 3', 'test', 'dibaca', 'menunggu', '2021-05-26 23:47:29', '2021-05-27 00:11:20'),
	(21, 50, 'warga lapor_1622045756_Screen Shot 2021-05-26 at 13.43.12.png', 'lapor 4', 'becek', 'dibaca', 'menunggu', '2021-05-27 00:15:56', '2021-05-27 00:16:27'),
	(22, 50, 'warga lapor_1622105086_5dc982f3e6411.jpg', 'pohon tumbang', 'ada pohon tumbang di dekat gang amin', 'dibaca', 'proses', '2021-05-27 16:44:46', '2021-05-27 16:56:27'),
	(23, 50, 'warga lapor_1622105227_rudi-salah-seorang-warga_20160907_124455.jpg', 'sampah mampet', 'tumpukan sampah di depan puskesmas', 'menunggu', 'menunggu', '2021-05-27 16:47:07', '2021-05-27 16:47:07');
...
-- Dumping data for table rtlapor.tbl_proses: ~7 rows (approximately)
...
INSERT INTO `users` (`id_users`, `name`, `username`, `email`, `notelp`, `kode_kecamatan`, `kode_kelurahan`, `nomor_rt`, `role`, `password`, `remember_token`, `pass_txt`, `isActive`, `isRT`, `created_at`, `updated_at`) VALUES
	(1, 'admin', 'admin', 'admin@gmail.com', '', '', '', 0, 'admin', '$2y$10$S0GdzoB9hPZIE2P0lweZ8epEpiOBzw6ETuqur8Mz1ba.e4w2YXQOm', 'rfW5GktAV5j69ej5Qv8iBAOKeaRPwVvRSLY9Gc9io9xD0xYhpaNiI2fNs9ET', 'admin123', 1, 0, NULL, NULL),
	(50, 'warga2', 'warga2', 'ikistudios.official@gmail.com', '08123', '647104', '6471041006', 1, 'warga', '$2y$10$YNHZDYgJR7sjUR6APXUzqews9qBBzvPCFkewSzBJJ.JIGo7Ud78f2', 'QVJGKDQmP5SftXvEuirRNLYAfnbReTXrzZOI8jlmsIlXhUsRbZo79Ei9mkSf', 'warga2', 1, 0, '2021-02-20 22:26:08', '2021-02-20 22:26:08'),
	(51, 'sumberrejo_rt1', 'sumberrejo_rt1', 'elsharionnn@gmail.com', '08123', '647104', '6471041006', 1, 'rt', '$2y$10$dXtKlIeUKilCAFJiODSrEOKoM8yrjEvEOEpu9/naHPmlrvwJwkFZm', 'IuMguP9pJqVyFr0qYrpFLbxNiqiAhA47KPFzoS35qyLPTOi4Ioo50ydJQ3d6', 'sumberrejo_rt1', 1, 1, '2021-02-20 22:45:30', '2021-02-21 17:11:46'),
